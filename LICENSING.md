...
[linkwarden/linkwarden](https://github.com/linkwarden/linkwarden) and recording what it does, not by translating
its source. See `../linkwarden-port/specs/SPEC-001-linkwarden.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for the
...
That code was written by the linkwarden/linkwarden project and is shipped here **verbatim**, reused
rather than rebuilt, per this harness's RENDERING.md R3. It remains under the licence its
authors chose, unmodified, in `LICENSE-linkwarden` and beside the code itself. Nothing
