...
[linkwarden/linkwarden](https://github.com/linkwarden/linkwarden) and recording what it does, not by translating its
source. See `../linkwarden-port/specs/SPEC-001-linkwarden.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for the
...
## The interface — AGPL-3.0, as linkwarden/linkwarden licensed it

- `frontend/`

That code was written by the linkwarden/linkwarden project, Copyright the linkwarden/linkwarden authors, and is shipped
here **verbatim**, reused rather than rebuilt, per this harness's RENDERING.md R3. It
remains under the licence its authors chose, unmodified, in `LICENSE-linkwarden` and beside
